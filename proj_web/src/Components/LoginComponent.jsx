      ...
      <div className="box flex justify-center items-center bg-white rounded-md shadow-xl w-1/4 h-1/2">
        <div className="grid items-center grid-rows-1 gap-10">
          ...
          <div>
            ...
            <div className="transition ease-in-out delay-100 font-suiteLight bg-kakao hover:bg-kakao_hover text-sm rounded-md p-2 mb-2 text-right shadow-md">
              카카오계정으로 로그인
            </div>
            <div className="transition ease-in-out delay-100 font-suiteLight bg-white hover:bg-white_hover  text-sm rounded-md p-2 text-right shadow-md">
              구글계정으로 로그인
            </div>
          </div>
        </div>
