...
export default function MainLogin({ show, onClose }) {
  return (
    <Modal className="flex fb-modal-sm" size="sm" show={show} onClose={onClose}>
      <div className="grow w-full h-full justify-center items-center">
        <div className="justify-center items-center bg-white rounded-md shadow-xl">
